import { r as reactExports, a2 as requireReact, V as React, W as jsxRuntimeExports, a3 as React$1 } from "./server-DP_nn76V.js";
import { S as Subscribable, s as shallowEqualObjects, h as hashKey, g as getDefaultState, n as notifyManager, u as useQueryClient, a as noop, b as shouldThrowError, B as BaseError$1, c as size, i as isHex, d as SliceOffsetOutOfBoundsError, e as assertSize, f as bytesToHex, j as hexToNumber, I as InvalidBytesBooleanError, k as hexToBigInt, l as numberToHex, m as isAddress, o as InvalidAddressError, p as padHex, q as boolToHex, r as IntegerOutOfRangeError, t as stringToHex, v as hexToBytes, w as checksumAddress, x as keccak256, y as toBytes, z as stringify, A as getContractAddress, C as InternalRpcError, D as InvalidInputRpcError, R as RpcRequestError, E as InvalidBytesLengthError, F as parseAccount, G as toHex, H as Hash, J as createView, K as aexists, L as toBytes$1, M as abytes, N as aoutput, O as clean, P as createHasher, Q as rotr, T as LruMap, U as ConnectorAlreadyConnectedError, V as createTransport, W as ConnectorUnavailableReconnectingError, X as ConnectorNotConnectedError, Y as ConnectorChainMismatchError, Z as getAddress, _ as ConnectorAccountNotFoundError, $ as createClient, a0 as SwitchChainNotSupportedError, a1 as ChainNotConfiguredError, a2 as BaseError$2, a3 as WagmiContext, a4 as ReactDOM, a5 as reactDomExports, a6 as ARC_TESTNET_ID, a7 as arcTestnet, a8 as TREASURY_ADDRESS, a9 as FEE_AMOUNT, aa as ERC20_ABI, ab as USDC_ADDRESS } from "./router-XlIotYmC.js";
...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1 } = await import("./secp256k1-D4nfgWW-.js");
  const signature_ = (() => {
...
async function internal_estimateMaxPriorityFeePerGas(client, args) {
  ...
  try {
    ...
    const [block, gasPrice] = await Promise.all([
      block_ ? Promise.resolve(block_) : getAction$1(client, getBlock, "getBlock")({}),
...
async function internal_estimateFeesPerGas(client, args) {
  ...
  const gasPrice = request?.gasPrice ?? multiply(await getAction$1(client, getGasPrice, "getGasPrice")({}));
  return {
    gasPrice
  };
}
async function getTransactionCount(client, { address, blockTag = "latest", blockNumber }) {
  const count2 = await client.request({
...
async function fillTransaction(client, parameters) {
  ...
  const nonce = await (async () => {
    ...
    const chainId = chain ? chain.id : await getAction$1(client, getChainId$1, "getChainId")({});
...
async function prepareTransactionRequest(client, args) {
  ...
  async function getChainId2() {
    ...
    if (chain)
      return chain.id;
    const chainId_ = await getAction$1(client, getChainId$1, "getChainId")({});
    chainId = chainId_;
    return chainId;
  }
  ...
  const fillResult = attemptFill ? await getAction$1(client, fillTransaction, "fillTransaction")({ ...request, nonce }).then((result) => {
  ...
  if (parameters.includes("gas") && typeof gas === "undefined")
    request.gas = await getAction$1(client, estimateGas, "estimateGas")({
      ...request,
      account,
...
class BaseError extends BaseError$2 {
  constructor() {
    super(...arguments);
...
function useConnectors(parameters = {}) {
  const config = useConfig(parameters);
  return reactExports.useSyncExternalStore((onChange) => watchConnectors(config, { onChange }), () => getConnectors(config), () => getConnectors(config));
}
...
function useConnections(parameters = {}) {
  const config = useConfig(parameters);
  return reactExports.useSyncExternalStore((onChange) => watchConnections(config, { onChange }), () => getConnections(config), () => getConnections(config));
}
...
const Gamepad2 = createLucideIcon("gamepad-2", __iconNode$6);
const __iconNode$5 = [
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        arcade: "bg-[var(--neon-green)] text-black font-bold uppercase tracking-wider shadow-[0_0_18px_color-mix(in_oklab,var(--neon-green)_55%,transparent)] hover:bg-[color-mix(in_oklab,var(--neon-green)_85%,white)] hover:shadow-[0_0_28px_color-mix(in_oklab,var(--neon-green)_70%,transparent)]",
        warn: "bg-[var(--warn)] text-black font-semibold hover:bg-[color-mix(in_oklab,var(--warn)_85%,white)] shadow-[0_0_14px_color-mix(in_oklab,var(--warn)_50%,transparent)]"
      },
      size: {
...
function short$1(addr) {
  if (!addr) return "";
  return `${addr.slice(0, 6)}…${addr.slice(-4)}`;
}
function WalletButton() {
  const { address, isConnected } = useConnection();
  const { connectors, connect: connect2, isPending } = useConnect();
  const { disconnect: disconnect2 } = useDisconnect();
  const chainId = useChainId();
  const { switchChain: switchChain2, isPending: switching } = useSwitchChain();
  if (!isConnected) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      {
        variant: "arcade",
        onClick: () => injected && connect2({ connector: injected, chainId: ARC_TESTNET_ID }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
    wrongNetwork && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        variant: "warn",
        size: "sm",
        onClick: () => switchChain2({ chainId: arcTestnet.id }),
        disabled: switching,
        children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-md border border-border bg-card/60 px-3 py-2 text-xs font-mono text-foreground shadow-[0_0_12px_color-mix(in_oklab,var(--neon-green)_30%,transparent)]", children: short$1(address) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: () => disconnect2(), title: "Disconnect", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { className: "h-4 w-4" }) })
  ] });
}
function NetworkBanner() {
  const { isConnected } = useConnection();
  const chainId = useChainId();
  const { switchChain: switchChain2, isPending } = useSwitchChain();
  if (!isConnected) return null;
  if (chainId === ARC_TESTNET_ID) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex flex-col gap-3 rounded-lg border border-warn/60 bg-warn/10 p-4 sm:flex-row sm:items-center sm:justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "mt-0.5 h-5 w-5 text-warn" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium text-foreground", children: [
        "Please switch to ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-warn", children: "Arc Testnet" }),
        " to continue."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function SnakeGame({
  ...
  reactExports.useEffect(() => {
    ...
    const step = () => {
      ...
      const nv = DIRS[s.dir];
      const next = { x: head.x + nv.x, y: head.y + nv.y };
      if (next.x < 0 || next.y < 0 || next.x >= GRID || next.y >= GRID || s.snake.some((c) => c.x === next.x && c.y === next.y)) {
        s.alive = false;
    ...
    const draw = () => {
      ...
      if (!ctx) return;
      const size2 = cvs.width;
      const cell = size2 / GRID;
      ...
      for (let i = 1; i < GRID; i++) {
        ctx.beginPath();
        ctx.moveTo(i * cell, 0);
        ctx.lineTo(i * cell, size2);
        ctx.stroke();
        ctx.beginPath();
        ctx.moveTo(0, i * cell);
        ctx.lineTo(size2, i * cell);
        ctx.stroke();
      }
      const s = stateRef.current;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full items-center justify-between font-pixel text-xs text-[var(--neon-green)]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "SCORE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg drop-shadow-[0_0_8px_var(--neon-green)]", children: String(score).padStart(4, "0") })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "canvas",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-muted-foreground", children: "Arrow keys / WASD on desktop · Swipe on mobile" })
  ] });
}
...
function addBonus(address, points) {
  const map = JSON.parse(localStorage.getItem(BONUS_KEY) || "{}");
...
function Leaderboard({ refreshKey }) {
  const scores = reactExports.useMemo(() => loadScores().slice(0, 10), [refreshKey]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-card/50 p-5 backdrop-blur", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-5 w-5 text-[var(--neon-green)]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-pixel text-sm tracking-wider text-foreground", children: "LEADERBOARD" })
    ] }),
    scores.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No scores yet. Be the first to make it on-chain." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "divide-y divide-border/60", children: scores.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "li",
      {
        className: "flex items-center justify-between gap-3 py-2.5 text-sm",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-pixel text-xs text-[var(--neon-green)]", children: [
            "#",
            String(i + 1).padStart(2, "0")
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 font-mono text-foreground", children: short(s.address) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-pixel tabular-nums text-foreground", children: String(s.score).padStart(4, "0") })
        ]
      },
      s.txHash + i
    )) })
...
function usePayFee() {
  ...
  const pay = reactExports.useCallback(async () => {
...
function Index() {
  ...
  const checkInRemaining = reactExports.useMemo(() => {
    if (!address) return 0;
  ...
  const handleGameOver = reactExports.useCallback((p) => {
    setPlaying(false);
    setGameOver(p);
  }, []);
  const handleSubmit = reactExports.useCallback(async () => {
    ...
    try {
      ...
      toast.success("Score submitted", {
        description: "Added to leaderboard."
      });
      setGameOver(null);
      setRefreshKey((k) => k + 1);
    } catch (e) {
  ...
  const cooldownLabel = reactExports.useMemo(() => {
    if (checkInRemaining <= 0) return "Available";
    const h = Math.floor(checkInRemaining / 36e5);
    const m = Math.floor(checkInRemaining % 36e5 / 6e4);
    const s = Math.floor(checkInRemaining % 6e4 / 1e3);
    return `${h}h ${m}m ${s}s`;
  }, [checkInRemaining]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-9 w-9 place-items-center rounded-md border border-[var(--neon-green)]/40 bg-black/40 shadow-[0_0_18px_color-mix(in_oklab,var(--neon-green)_40%,transparent)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Gamepad2, { className: "h-5 w-5 text-[var(--neon-green)]" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-pixel text-[10px] tracking-widest text-[var(--neon-green)] sm:text-xs", children: "SNAKE ON ARC" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "Powered by Circle USDC" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(WalletButton, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-6xl px-4 pb-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(NetworkBanner, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-8 grid gap-3 sm:grid-cols-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "h-4 w-4" }), label: "Entry / Submit / Check-in", value: "0.1 USDC" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4" }), label: "Your bonus points", value: String(bonus) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarCheck, { className: "h-4 w-4" }), label: "Daily check-in", value: cooldownLabel })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-[1.4fr_1fr]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scanline relative overflow-hidden rounded-xl border border-border bg-card/40 p-5 backdrop-blur", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SnakeGame, { active: playing, onGameOver: handleGameOver }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex flex-wrap items-center justify-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "arcade", size: "lg", onClick: handlePlay, disabled: !onArc || playing || starting, children: starting ? "Confirm in wallet…" : playing ? "Game in progress" : "Play Game (0.1 USDC)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "lg", onClick: handleCheckIn, disabled: !onArc || checkInRemaining > 0 || checking, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarCheck, { className: "mr-2 h-4 w-4" }),
              checking ? "Confirm in wallet…" : checkInRemaining > 0 ? `Check-in in ${cooldownLabel}` : "Daily Check-In (+10)"
            ] })
          ] }),
          !isConnected && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-center text-sm text-muted-foreground", children: "Connect your wallet to begin." }),
          isConnected && !onArc && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-center text-sm text-warn", children: "Switch to Arc Testnet to enable gameplay." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Leaderboard, { refreshKey })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-12 text-center text-xs text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Arc Testnet · Chain ID ",
        ARC_TESTNET_ID,
        " ·",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "underline hover:text-[var(--neon-green)]", href: "https://faucet.circle.com/", target: "_blank", rel: "noreferrer", children: "Get testnet USDC" }),
        " ",
        "·",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { className: "inline-flex items-center gap-1 underline hover:text-[var(--neon-green)]", href: "https://testnet.arcscan.app", target: "_blank", rel: "noreferrer", children: [
          "ArcScan ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3 w-3" })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!gameOver, onOpenChange: (o) => !o && setGameOver(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "border-[color-mix(in_oklab,var(--neon-green)_40%,transparent)] bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-pixel text-sm tracking-widest text-[var(--neon-green)]", children: "GAME OVER" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { children: [
          "Final score:",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-pixel text-foreground", children: String(gameOver?.score ?? 0).padStart(4, "0") }),
          bonus > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            " ",
            "+ bonus",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-pixel text-[var(--neon-green)]", children: bonus })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2 sm:gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", onClick: () => setGameOver(null), children: "Close" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "arcade", onClick: handleSubmit, disabled: submitting || !onArc, children: submitting ? "Confirm in wallet…" : "Submit Score (0.1 USDC)" })
      ] })
    ] }) })
  ] });
}
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-card/40 p-4 backdrop-blur", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-1 flex items-center gap-2 text-xs uppercase tracking-wider text-muted-foreground", children: [
      icon,
      label
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-pixel text-base text-foreground", children: value })
  ] });
}
