...
function encode(obj, stringify2 = String) {
...
const appCss = "/arc-snake-quest/assets/styles-C0DY5Amv.css";
...
let BaseError$1 = class BaseError2 extends Error {
  ...
  constructor(shortMessage, options = {}) {
    ...
    const details = options.cause instanceof BaseError2 ? options.cause.details : options.cause?.message ? options.cause.message : options.details;
...
function Web3Provider({ children }) {
  ...
  if (!mounted) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Snake on Arc — Web3 Mini Game on Arc Testnet" },
      {
        name: "description",
        content: "Play classic Snake on Arc Testnet. Pay 0.1 USDC to play, submit scores on-chain, and climb the global leaderboard."
      },
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Web3Provider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) });
}
const $$splitComponentImporter = () => import("./index-CA6lIQd0.js").then((n) => n.i);
...
export {
  createClient as $,
  getContractAddress as A,
  BaseError as B,
  InternalRpcError as C,
  InvalidInputRpcError as D,
  InvalidBytesLengthError as E,
  parseAccount as F,
  toHex as G,
  Hash as H,
  InvalidBytesBooleanError as I,
  createView as J,
  aexists as K,
  toBytes as L,
  abytes as M,
  ...
  createHasher as P,
  rotr as Q,
  RpcRequestError as R,
  Subscribable as S,
  LruMap as T,
  ConnectorAlreadyConnectedError as U,
  createTransport as V,
  ConnectorUnavailableReconnectingError as W,
  ConnectorNotConnectedError as X,
  ConnectorChainMismatchError as Y,
  getAddress as Z,
  ConnectorAccountNotFoundError as _,
  noop as a,
  SwitchChainNotSupportedError as a0,
  ChainNotConfiguredError as a1,
  BaseError$1 as a2,
  WagmiContext as a3,
  ReactDOM as a4,
  reactDomExports as a5,
  ARC_TESTNET_ID as a6,
  arcTestnet as a7,
  TREASURY_ADDRESS as a8,
  FEE_AMOUNT as a9,
  ERC20_ABI as aa,
  USDC_ADDRESS as ab,
  ahash as ac,
  ...
  size$2 as c,
  SliceOffsetOutOfBoundsError as d,
  assertSize as e,
  bytesToHex as f,
  ...
  padHex as p,
  boolToHex as q,
  IntegerOutOfRangeError as r,
  shallowEqualObjects as s,
  stringToHex as t,
  useQueryClient as u,
  hexToBytes as v,
  checksumAddress as w,
  keccak256 as x,
  toBytes$1 as y,
  stringify as z
};
